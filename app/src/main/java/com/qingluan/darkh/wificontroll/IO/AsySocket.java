...
//    public   void AsySend(final byte[] data, final ErrorCallbackListener listener){
//        Runnable sendRunable = new Runnable() {
//            @Override
//            public void run() {
//                send(data,context,listener);
...
//        sendThread.start();
    ...
    public interface ErrorCallbackListener {
        public void  dealError(Context context,Exception error);
    }
